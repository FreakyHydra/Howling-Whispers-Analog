      ...
      <section class="daw-panel" aria-label="Howling Whispers DAW concept">
        <header class="daw-head">
          <div>
            ...
            <h2>DAW</h2>
            <p class="subtitle">Loop arrangement laboratory · Concept 0.1</p>
          </div>
        ...
        <div class="daw-grid">
          <aside class="loop-library">
            ...
            <p class="daw-help">Select a saved loop, then click an arrangement slot to place it.</p>
            <div id="daw-library" class="daw-library" aria-live="polite"></div>
          </aside>

          <section class="arranger">
            <div class="module-title"><span>ARRANGEMENT</span><small>12 LOOP SLOTS</small></div>
